...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'platform_homepage');
            }

            return array (  '_controller' => 'MMJBTL\\PlatformBundle\\Controller\\PlatformController::indexAction',  '_route' => 'platform_homepage',);
        }
